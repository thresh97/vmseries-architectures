...
| [azure/](azure/) — PAN-OS A/P HA | Azure | Hub-and-spoke, native PAN-OS Active/Passive HA with dedicated HA1/HA2 links — ARS BGP peering via floating trust IP works; BGP reconverges via ARS keepalive after IP migration; untuned ~60s end-to-end failover | deployment-guide · orig | working | well-worn-path |
